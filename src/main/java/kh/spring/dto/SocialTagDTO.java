...
public class SocialTagDTO {
	...
	public SocialTagDTO(int tag_seq, int social_tag, String tag_name, String tag_brand, String tag_store, String tag_url, String tag_lat, String tag_along) {
		super();
	...
	public int getSocial_tag() {
		return social_tag;
	}
	
	public void setSocial_tag(int social_tag) {
		this.social_tag = social_tag;
	}
