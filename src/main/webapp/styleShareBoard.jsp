                ...
                <section class=border-bottom-line>
                    ...
                    <ol>
                        <li class="mb-2">
                            <div>Black Shirt</div>
                            <div>
                                <a href="http://www.zara.com/">Primark</a> in
                                <a href="">Primark Fedoras</a>
                            </div>
                        </li>
                        <li class="mb-2">
