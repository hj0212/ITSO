...
<input type="hidden" id="tip_seq" value="${tipSeq}">
	...
	<script>
		window.onload = function() {
			...
			document.getElementById("writeBtn").onclick = function() {
				...
				var data = JSON
						.stringify({
							tip_seq : document.getElementById("tip_seq").value,
